    ...
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-4">
        <img
          ...
          style={{ width: '48px', height: '48px', borderRadius: '50%', border: '1px solid var(--border-default)', background: 'var(--background-surface)' }}
        />
        <div className="flex flex-col gap-1 min-w-0">
          <a
            ...
            style={{ fontWeight: 600, color: 'var(--text-primary)', fontSize: 'var(--typescale-body)' }}
          >
            @{username}
          </a>
          <a
...
function DisconnectedSection() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <p style={{ fontSize: 'var(--typescale-body)', color: 'var(--text-primary)', lineHeight: 'var(--lineHeight-medium)', margin: 0 }}>
      ...
      <div className="flex flex-col gap-3">
        ...
        />
        <p className="hint">
          Needs <code style={{ fontFamily: 'monospace', background: 'var(--background-surface)', padding: '1px 5px', borderRadius: 'var(--radius-sm)' }}>repo</code> scope.
...
function ReadOnlyField({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <span style={{ fontSize: 'var(--typescale-body)', color: 'var(--text-primary)' }}>{value}</span>
    </div>
  )
}
      ...
      <main className="max-w-xl mx-auto px-4 py-10 flex flex-col gap-10" style={{ paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
        ...
        <section className="flex flex-col gap-4">
          ...
          <Card className="p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  style={{ cursor: 'default', borderRadius: 'var(--radius-md)' }}
                >
                  Botanical
                </button>
                <button
            ...
            <div className="flex gap-8" style={{ borderTop: '1px solid var(--border-default)', paddingTop: 'var(--spacing-5)' }}>
