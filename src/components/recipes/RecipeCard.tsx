...
export function RecipeCard({ recipe, onSelect }: RecipeCardProps) {
  return (
    <button
      ...
      className="group w-full text-left bg-surface-raised border border-border rounded-lg overflow-hidden transition-shadow hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-accent cursor-pointer"
    >
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="text-xs text-content-muted font-body shrink-0">
            {recipe.prepTime}
          </span>
        </div>
      </div>
